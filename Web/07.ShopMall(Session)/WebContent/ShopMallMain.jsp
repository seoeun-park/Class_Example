...
String[] name = {"사과1", "사과2", "사과3", "바나나1", "바나나2", 
				 "바나나3", "배1", "배2", "배3"};
String[] price = {"1,500", "1,600", "1,700", "3,000", "3,500", "4,000",
				  "5,000", "6,000", "7,000"};
%>
	...
	<div align="center">
		...
		<table border="1">
			...
			for(int i = 0; i < img.length; i++) {
				...
				out.println("<tr align='center'><td><b>" + name[i] + "</b></td></tr>");
				
				out.println("<tr align='center'><td><b> ￦" + price[i] + "원</b></td></tr>");

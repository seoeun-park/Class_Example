	...
	<div align="center">
		...
		<form action="memberUpdateAction.me" method="post" onsubmit="return fnSubmit()">
			...
			<table border="1">
				...
				<tr>
					<th>나이</th>
					<td><input type="number" name="member_age" value="${dto.member_age }" /></td>
				</tr>
				<tr>
					<th>성별</th>
					<td>
				...
				<tr>
					<th>이메일</th>
					<td>
						<c:if test="${dto.member_gender eq null}">
							<input type="text" name="member_email" value="" />
						</c:if>
						<c:if test="${dto.member_gender ne null}">

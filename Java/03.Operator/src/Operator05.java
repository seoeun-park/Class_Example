public class Operator05 {
	public static void main(String[] args) {
		// 논리연산자 : 여러 개의 조건을 판단 ▶ 조건문에 많이 사용
		// 연산의 결과는 true, false 반환
		// 조건A && 조건B : 조건A가 참이고 조건B도 참일 경우 → true 출력
		// 조건A || 조건B : 조건A 또는 조건B 중에서 하나라도 참일 경우 → true 출력
		// && : AND조건(주어진 조건이 모두 만족)   ▶ ~~이면서, ~~이고
		// || : OR조건(하나라도 만족)   ▶ ~~이거나, ~~또는
		...
		// Dead Code → 죽은 코드라는 뜻으로 해당 code를 해석하기 이전에 이미 결과가 나왔다는 의미이다.

public class Test_Method01 {
	public static void main(String[] args) {
		/*	   
 		// 1부터 50까지의 누적 합(sum)을 구하시오. : a ~ b까지의 합을 구하시오
		int a = 1, b = 50;
		int sum = 0;
		...
		// 51부터 100까지의 누적합(sum) : c ~ d까지의 합을 구하시오.
		int c = 51, d = 100;
		sum = 0;
		...
		*/
		...
		int a = 1, b = 50, c = 51, d = 100;		//매개변수 값을 초기화
	...
	// 두 개의 정수를 전달받아 누적 합(sum)을 구하고 출력하는 메소드(getSum())를 정의

...
public class JSONTestMain01 {
	public static void main(String[] args) {
		...
		array.add(object);				//JSON Object를 JSON Array에 등록(저장)
		...
		String json = array.toString();		//JSON 형식의 내용을 출력
		System.out.println(json);
		
		//결과를 화면에 출력 (JSONObject를 JsonDTO로 변환)
		...
		//결과를 파일로 저장
		try {
			FileWriter fw = new FileWriter("member.json");		//현재 프로젝트에 저장
